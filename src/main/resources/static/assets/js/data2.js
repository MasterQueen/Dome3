...
function goChart(){
    ...
    var dataArr = [ [income_other_all,"#C630C8","玉米"],[sponsor_all,"#2dc6c8","瓜子"], [studnet_all,"#b6a2dd", "花生"]];
    // 声明所需变量
    var canvas,ctx;
    // 图表属性
...
var chartData2 = [[700,"#2dc6c8","瓜子"], [80,"#b6a2dd", "花生"], [200,"#5ab1ee","土豆"], [100,"#d7797f","南瓜四号"]];
